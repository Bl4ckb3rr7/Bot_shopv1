...
async def cmd_start(message:Message):
    ...
    await message.answer('Добро пожаловать в магазин Гуччи в Санкт-Петербурге!',reply_markup= kb.main)

@router.message(F.text == 'Каталог')
async def catalog(message: Message):
    await message.answer('Выберите категорию товара', reply_markup=await kb.catalog())
